    ...
    if (error.response) {
        switch (error.response.status) {
            case 401:
                ...
                snackbarError('Nie udało się zalogować. Niepoprawny email lub hasło.');
                break;
            case 423:
                // Konto zablokowane
                snackbarError('Twoje konto zostało zablokowane. Skontaktuj się z administratorem.');
                break;
            case 500:
            default:
                // Ogólny błąd serwera
        ...
        snackbarError('Brak odpowiedzi z serwera. Sprawdź połączenie z internetem i spróbuj ponownie.');
    }
}
